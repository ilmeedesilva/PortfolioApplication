...
const submit_button2 = document.querySelector(".slider_info");
...
submit_button2.addEventListener("click", (e) => {
    ...
    if(!desc3.value)
    {
      ...
      ) 
      {
        ...
        // };
        xhr.send(
          `title1=${title1.value}&desc1=${desc1.value}&title2=${title2.value}&desc2=${desc2.value}&title3=${title3.value}&desc3=${desc3.value}`// me tiyene value tika php eketa pass karana
        );
      }
