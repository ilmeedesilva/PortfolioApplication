const fileInput = document.querySelector(
  '.add_new_project_img_wrapper input[type="file"]'
);
const label = document.querySelector(".add_new_project_img_wrapper");
const fileName = document.querySelector(".img_uploader .add_project_file_name");

const imgErrorTxt = document.querySelector(
  ".img_uploader .add_project_error_img"
);
